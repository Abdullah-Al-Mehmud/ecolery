...
export const pressArticles: PressArticle[] = [
  {
    ...
    body: [
      ...
      "Across several weeks of virtual sessions, participants shared how their ventures were tackling everything from plastic waste to energy poverty — and, more importantly, what was working.",
      ...
      "Peer leadership, we learned, is less about mentorship from above and more about standing shoulder to shoulder — which is exactly how we want to grow.",
    ],
  },
  {
    ...
    body: [
      ...
      "The grant recognises our Green Generation school program, which pairs plastic-free products with classroom education — helping students understand why the everyday choices they make matter for the planet.",
