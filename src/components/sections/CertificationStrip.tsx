...
export function CertificationStrip() {
  const certs = [
    ...
    { src: "/icons/petroleum.png", alt: "No Petroleum" },
  ...
  return (
    <section className="bg-cream border-y border-black/5 px-4 py-8 sm:px-6 sm:py-10">
      <div className="mx-auto grid max-w-7xl grid-cols-3 items-center justify-items-center gap-4 sm:grid-cols-6 sm:gap-6 md:gap-10">
        {certs.map((cert) => (
