...
export function ImpactHero() {
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden bg-cream px-6 pt-32 pb-24 md:pt-40 md:pb-32">
      <div
        aria-hidden
      ...
      <span
        aria-hidden
        className="font-fraunces text-ink/[0.05] pointer-events-none absolute -right-6 -bottom-16 hidden text-[16rem] leading-none font-semibold tracking-tight select-none lg:block"
      >
        160k
      </span>
      ...
      >
        <motion.div variants={itemVariants} className="max-w-2xl lg:col-span-7">
          ...
          <h1 className="font-fraunces text-ink mt-6 text-4xl leading-[1.05] font-semibold tracking-tight sm:text-5xl lg:text-6xl">
            Change you can <span className="text-primary-dark">count.</span>
          </h1>
        ...
        <motion.div variants={itemVariants} className="lg:col-span-5">
          <div className="bg-white shadow-sm rounded-2xl p-7 md:p-8">
            <div className="flex items-center justify-between">
              <p className="font-body text-ink/50 text-[12px] font-semibold tracking-[0.2em] uppercase">
                2025 Scorecard
              </p>
              <span className="border-primary/30 text-primary font-display flex h-8 items-center rounded-full border px-3 text-[10px] font-bold tracking-[0.14em] uppercase">
                Verified
              </span>
            </div>
            ...
            <p className="font-body mt-2 text-[11px] font-semibold text-ink/40">
